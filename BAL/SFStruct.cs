...
namespace BioStationAPI
{
    ...
    public static class BS2Envirionment
    {
    ...
    public struct BS2FactoryConfig
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAC_ADDR_LEN)]
        public byte[] macAddr;
        public UInt16 reserved;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MODEL_NAME_LEN)]
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_KERNEL_REV_LEN)]
        public byte[] kernelRev;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_BSCORE_REV_LEN)]
        public byte[] bscoreRev;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_FIRMWARE_REV_LEN)]
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_USER_ID_SIZE)]
        public byte[] userID;
        public byte level;
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_NUM_OF_AUTH_MODE)]
        ...
        public byte reserved2;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_OPERATORS)]
    ...
    public struct BS2LedStatusConfig
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_LED_SIGNAL_NUM)]
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_DEVICE_STATUS_NUM)]
    ...
    public struct BS2DisplayConfig
    {
        ...
        public byte reserved;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_SHORTCUT_HOME)]
        public byte[] shortcutHome;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_TNA_KEY)]
        public byte[] tnaIcon;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
        public byte[] reserved2;
    }
    ...
    public struct BS2IpConfig
    {
        ...
        public byte useDNS;
        public byte reserved;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_IPV4_ADDR_SIZE)]
    ...
    public struct BS2IpConfigExt
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_IPV4_ADDR_SIZE)]
        public byte[] dnsAddr;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_URL_SIZE)]
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_TNA_KEY * BS2Envirionment.BS2_MAX_TNA_LABEL_LEN)]
    ...
    public struct BS2CSNCard
    {
        public byte type;
        public byte size;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_CARD_DATA_SIZE)]
        public byte[] data;
    }
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_PIN_HASH_SIZE)]
        public byte[] pin;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_SMART_CARD_MAX_TEMPLATE_COUNT*BS2Envirionment.BS2_FINGER_TEMPLATE_SIZE)]
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_SMART_CARD_MAX_ACCESS_GROUP_COUNT)]
    ...
    public struct BS2DesFireCard
    {
        ...
        public byte[] appID;
        public byte fileID;
        public byte encryptionType; //for DesFire DES/3DES or AES. AES will be provided at future(TBD).
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
        public byte[] reserved;
    }
    ...
    public struct BS2Fingerprint
    {
        ...
        public byte flag;
        public UInt16 reserved;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_TEMPLATE_PER_FINGER * BS2Envirionment.BS2_FINGER_TEMPLATE_SIZE)]
        public byte[] data;
    }
    ...
    public struct BS2Rs485Channel
    {
        ...
        public byte reserved;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_RS485_MAX_SLAVES_PER_CHANNEL)]
    ...
    public struct BS2Rs485Config
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
        public byte[] reserved1;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_RS485_MAX_CHANNELS)]
    ...
    public struct BS2WiegandFormat
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_WIEGAND_MAX_FIELDS * BS2Envirionment.BS2_WIEGAND_FIELD_SIZE)]
        public byte[] idFields;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_WIEGAND_MAX_PARITIES * BS2Envirionment.BS2_WIEGAND_FIELD_SIZE)]
        public byte[] parityFields;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_WIEGAND_MAX_PARITIES)]
    ...
    public struct BS2WiegandDeviceConfig
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_WIEGAND_STATUS_NUM)]
    ...
    public struct BS2InputConfig
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_INPUT_NUM)]
    ...
    public struct BS2WlanConfig
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_WLAN_SSID_SIZE)]
        public byte[] essid;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_WLAN_KEY_SIZE)]
        public byte[] authKey;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
        public byte[] reserved;
    }   
    ...
    {
        public UInt16 count; //(0 = disabled, -1 = infinite)
    ...
    public struct BS2BuzzerAction
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public byte[] reserved;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_BUZZER_SIGNAL_NUM)]
        public BS2BuzzerSignal[] signal;
    }
    ...
    public struct BS2TriggerActionConfig
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
        public byte[] reserved;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_TRIGGER_ACTION)]
    ...
    public struct BS2EventConfig
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_EVENT_MAX_IMAGE_CODE_COUNT)]
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.MAX_WIEGAND_IN_COUNT)]
    ...
    public struct BS2UserPhoneItem
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_DESCRIPTION_NAME_LEN)]
    ...
    public struct BS2VoipConfig
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_VOIP_MAX_PHONEBOOK)]
    ...
    public struct BS2Rs485ConfigEX
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
        public byte[] reserved1;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_RS485_MAX_CHANNELS_EX)]
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_ZONE_NAME_LEN)]
        public byte[] name;
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_ENTRANCE_LIMIT_PER_ZONE)]
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_READERS_PER_DEVICE_ZONE_ENTRANCE_LIMIT)]
        public BS2DeviceZoneEntranceLimitMemberInfo[] readers;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_DEVICE_ZONE_ENTRANCE_LIMIT_ALARM_ACTION)]
        public BS2Action[] alarm;

        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_BYPASS_GROUPS_PER_DEVICE_ZONE_ENTRANCE_LIMIT)]
    ...
    public struct BS2DeviceZoneAGEntranceLimit
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_ENTRANCE_LIMIT_PER_ZONE * BS2Envirionment.BS2_MAX_ACCESS_GROUP_ENTRANCE_LIMIT_PER_ENTRACE_LIMIT)]
    ...
    public struct BS2DeviceZoneFireAlarmMaster
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_READERS_PER_DEVICE_ZONE_FIRE_ALARM)]
        public BS2DeviceZoneFireAlarmMemberInfo[] readers;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_DEVICE_ZONE_FIRE_ALARM_ALARM_ACTION)]
        public BS2Action[] alarm;
    ...
    public struct BS2DeviceZoneFireAlarmMember
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_FIRE_SENSORS_PER_DEVICE_ZONE_FIRE_ALARM_MEMBER)]
        public BS2DeviceZoneFireSensor[] sensor;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_DOORS_PER_DEVICE_ZONE_FIRE_ALARM_MEMBER)]
    ...
    public struct BS2DeviceZoneConfig
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_DEVICE_ZONE)]
    ...
    {
        public UInt32 doorID;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_DOOR_NAME_LEN)]
        public byte[] name;
        ...
        public byte lockFlags;
        public byte alarmFlags;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_FORCED_OPEN_ALARM_ACTION)]
        public BS2Action[] forcedOpenAlarm;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_HELD_OPEN_ALARM_ACTION)]
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
        public byte[] reserved3;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_DUAL_AUTH_APPROVAL_GROUP)]
    ...
    public struct BS2ResourceElement
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_RESOURCE_ITEM_COUNT)]
    ...
    public struct BS2Face
    {
        ...
        public UInt16 reserved2;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_FACE_IMAGE_SIZE)]
        public byte[] imageData;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_TEMPLATE_PER_FACE * BS2Envirionment.BS2_FACE_TEMPLATE_LENGTH)]
        public byte[] templateData;
    }
    ...
    {
        public UInt32 size;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_USER_PHOTO_SIZE)]
        public byte[] data;
    }
    ...
    {
        public UInt32 code;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_JOBLABEL_LEN)]
        public byte[] label;
    }
    ...
    public struct BS2Job
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
        public byte[] reserved;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_JOB_SIZE)]
    ...
    public struct BS2UserBlob
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_USER_NAME_LEN)]
        public byte[] name;
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_ACCESS_GROUP_PER_USER)]
        public UInt32[] accessGroupId;
    }
    ...
    public struct BS2UserBlobEx
    {
        ...
        public IntPtr faceObjs;
        public BS2Job job;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_USER_PHRASE_SIZE)]
        public byte[] phrase;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_ACCESS_GROUP_PER_USER)]
        public UInt32[] accessGroupId;
    }
    ...
    public struct BS2EventBlob
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_EVENT_MAX_IMAGE_SIZE)]
        public byte[] image;
        public byte reserved;
    }
    ...
    {
        [FieldOffset(0)]
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_ACCESS_LEVEL_PER_ACCESS_GROUP)]
    ...
    {
        public UInt32 id;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_ACCESS_GROUP_NAME_LEN)]
        public byte[] name;
    ...
    {
        public UInt32 id;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_ACCESS_LEVEL_NAME_LEN)]
        public byte[] name;
        public byte numDoorSchedules;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
        public byte[] reserved;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_ACCESS_LEVEL_ITEMS)]
    ...
    public struct BS2DaySchedule
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
        public byte[] reserved;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_TIME_PERIODS_PER_DAY)]
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_NUM_WEEKDAYS)]
    ...
    public struct BS2DailySchedule
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
        public byte[] reserved;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_DAYS_PER_DAILY_SCHEDULE)]
        public BS2DaySchedule[] schedule;
    }
    ...
    //{
    //    public UInt32 id;
    //    [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_SCHEDULE_NAME_LEN)]
    //    public byte[] name;
    //    public byte isDaily;
    ...
    //    [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_HOLIDAY_GROUPS_PER_SCHEDULE)]
    ...
    {
        public UInt32 id;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_HOLIDAY_GROUP_NAME_LEN)]
        public byte[] name;
        public byte numHolidays;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
        public byte[] reserved;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_HOLIDAYS_PER_GROUP)]
    ...
    public struct BS2AntiPassbackZone
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_APB_ALARM_ACTION)]
        public BS2Action[] alarm;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_READERS_PER_APB_ZONE)]
        public BS2ApbMember[] readers;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 512)]
        public byte[] reserved2;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_BYPASS_GROUPS_PER_APB_ZONE)]
        public UInt32[] bypassGroupIDs;
    }
    ...
    public struct BS2TimedAntiPassbackZone
    {
        ...
        public byte[] reserved;
        public UInt32 resetDuration; //in seconds, 0: no reset
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_TIMED_APB_ALARM_ACTION)]
        public BS2Action[] alarm;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_READERS_PER_TIMED_APB_ZONE)]
        public BS2TimedApbMember[] readers;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 320)]
        public byte[] reserved2;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_BYPASS_GROUPS_PER_TIMED_APB_ZONE)]
        public UInt32[] bypassGroupIDs;
    }
    ...
    public struct BS2FireAlarmZone
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)]
        public byte[] reserved;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_FIRE_SENSORS_PER_FIRE_ALARM_ZONE)]
        public BS2FireSensor[] sensor;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_FIRE_ALARM_ACTION)]
        public BS2Action[] alarm;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
        public byte[] reserved2;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_DOORS_PER_FIRE_ALARM_ZONE)]
        public UInt32[] doorIDs;
    }
    ...
    public struct BS2ScheduledLockUnlockZone
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 6)]
        public byte[] reserved;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_SCHEDULED_LOCK_UNLOCK_ALARM_ACTION)]
        public BS2Action[] alarm;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
        public byte[] reserved2;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_DOORS_IN_SCHEDULED_LOCK_UNLOCK_ZONE)]
        public UInt32[] doorIDs;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_BYPASS_GROUPS_IN_SCHEDULED_LOCK_UNLOCK_ZONE)]
        public UInt32[] bypassGroupIDs;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_UNLOCK_GROUPS_IN_SCHEDULED_LOCK_UNLOCK_ZONE)]
    ...
    {
        public UInt32 id;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_AUTH_GROUP_NAME_LEN)]
        public byte[] name;        
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
        public byte[] reserved;        
    }
    ...
    {
        public UInt32 id;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_FLOOR_LEVEL_NAME_LEN)]
        public byte[] name;
        public byte numFloorSchedules;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
        public byte[] reserved;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_FLOOR_LEVEL_ITEMS)]
    ...
    {
        public UInt32 liftID;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_LIFT_NAME_LEN)]
        public byte[] name;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_DEVICES_ON_LIFT)]
        public UInt32[] deviceID;
        ...
        public UInt32 dualAuthScheduleID;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_FLOORS_ON_LIFT)]
        public BS2LiftFloor[] floor;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_DUAL_AUTH_APPROVAL_GROUP_ON_LIFT)]
        public UInt32[] dualAuthApprovalGroupID;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_ALARMS_ON_LIFT)]
    ...
    public struct BS2DstConfig
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 31)]
        public byte[] reserved;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_MAX_DST_SCHEDULE)]
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = BS2Envirionment.BS2_ENC_KEY_SIZE)]
        public byte[] key;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
        public byte[] reserved;
    }
