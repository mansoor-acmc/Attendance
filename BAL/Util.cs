...
{    
    class Util
    {
        ...
        public static DateTime ConvertFromUnixLocalTimestamp(double timestamp)
        {
        ...
        private static string GetDoorIdMsg(BS2Event eventLog)
        {
            ...
            return String.Format("DoorId Log => device[{0, 10}] : timestamp[{1}] event id[{2, 10}] event code[{3}] doorID[{4}] image[{5}]", 
                                eventLog.deviceID,
        ...
        private static string GetZoneIdMsg(BS2Event eventLog)
        {
            ...
            return String.Format("ZoneId Log => device[{0, 10}] : timestamp[{1}] event id[{2, 10}] event code[{3}] zoneID[{4}] image[{5}]",
                                eventLog.deviceID,
                                eventTime.ToString("yyyy-MM-dd HH:mm:ss"),
                                eventLog.id,
                                (BS2EventCodeEnum)eventLog.code,
        ...
        private static string GetIOInfoMsg(BS2Event eventLog)
        {
            ...
            return String.Format("IOInfo Log => device[{0, 10}] : timestamp[{1}] event id[{2, 10}] event code[{3}] device[{4, 10}] port[{5}] value[{6}] image[{7}]",
                                eventLog.deviceID,
                                eventTime.ToString("yyyy-MM-dd HH:mm:ss"),
                                eventLog.id,
                                (BS2EventCodeEnum)eventLog.code,
        ...
        private static string GetUserIdMsg(BS2Event eventLog)
        {
            ...
            return String.Format("UserId Log => device[{0, 10}] : timestamp[{1}] event id[{2, 10}] event code[{3}] userID[{4}] image[{5}]",
                                eventLog.deviceID,
                                eventTime.ToString("yyyy-MM-dd HH:mm:ss"),
                                eventLog.id,
                                (BS2EventCodeEnum)eventLog.code,
        ...
        private static string GetUserIdAndTnaKeyMsg(BS2Event eventLog)
        {
            ...
            return String.Format("UserIdAndTnaKey Log => device[{0, 10}] : timestamp[{1}] event id[{2, 10}] event code[{3}] {4} image[{5}]",
                                eventLog.deviceID,
                                eventTime.ToString("yyyy-MM-dd HH:mm:ss"),
                                eventLog.id,
                                (BS2EventCodeEnum)eventLog.code,
        ...
        {
            DateTime eventTime = ConvertFromUnixTimestamp(eventLog.dateTime);
            return String.Format("General Log => device[{0, 10}] : timestamp[{1}] event id[{2, 10}] event code[{3}] image[{4}]",
                                eventLog.deviceID,
                                eventTime.ToString("yyyy-MM-dd HH:mm:ss"),
                                eventLog.id,
                                (BS2EventCodeEnum)eventLog.code,
