...
//Debug
BS_API_EXPORT int BS_CALLING_CONVENTION BS2_SetDebugLevel(CBDebugPrint ptrCBDebugPrint, uint32_t debugLevel);
BS_API_EXPORT int BS_CALLING_CONVENTION BS2_SetDebugExCallback(CBDebugExPrint ptrCBDebugExPrint, uint32_t level, uint32_t module);
...
BS_API_EXPORT int BS_CALLING_CONVENTION BS2_GetDevicesCoreStation(void* context, BS2_DEVICE_ID** device_list, uint32_t* numDevice);
...
BS_API_EXPORT int BS_CALLING_CONVENTION BS2_GetAccessGroupEntranceLimit(void* context, BS2_DEVICE_ID deviceId, const BS2_ZONE_ID* Ids, uint32_t IdCount, BS2DeviceZoneAGEntranceLimit** agEntranceLimitObj, uint32_t* numAGEntranceLimit);
BS_API_EXPORT int BS_CALLING_CONVENTION BS2_GetAllAccessGroupEntranceLimit(void* context, BS2_DEVICE_ID deviceId, BS2DeviceZoneAGEntranceLimit** agEntranceLimitObj, uint32_t* numAGEntranceLimit);
BS_API_EXPORT int BS_CALLING_CONVENTION BS2_SetAccessGroupEntranceLimit(void* context, BS2_DEVICE_ID deviceId, const BS2DeviceZoneAGEntranceLimit* agEntranceLimits, uint32_t agEntranceLimitCount);
BS_API_EXPORT int BS_CALLING_CONVENTION BS2_RemoveAccessGroupEntranceLimit(void* context, BS2_DEVICE_ID deviceId, const BS2_ZONE_ID* Ids, uint32_t IdCount);
BS_API_EXPORT int BS_CALLING_CONVENTION BS2_RemoveAllAccessGroupEntranceLimit(void* context, BS2_DEVICE_ID deviceId);
